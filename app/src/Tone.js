...
import { maths, arrays } from 'varyd-utils';
...
const NOTES = {
  ...
  'E6': 1318.51,
  'F6': 1396.91, 'F#6': 1479.98, 'Gb6': 1479.98,
...
export default class Tone {
  ...
  play(freq, duration) {
    ...
    this.gainNode.gain.setValueAtTime(this.gain, this.now);

    this.oscillator.start(this.now);
    this.stop(this.now + duration);

  }

  playNote(note, duration) {

    this.play(NOTES[note], duration);

  }

  stop(time) {

    this.gainNode.gain.setTargetAtTime(0, time - 0.5, 0.1);
